...
export const esES: I18nLocale = {
	...
	languageSelector: {
		...
		language: "Idioma",
		changeLanguageError:
			"Se ha producido un error al configurar el nuevo idioma. Por favor, asegúrate de que tu dispositivo esté conectado a Internet, reinicia la aplicación e inténtalo de nuevo",
	},
