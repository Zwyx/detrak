...
export const nl: I18nLocale = {
	...
	languageSelector: {
		...
		language: "Taal",
		changeLanguageError:
			"Er is een fout opgetreden bij het instellen van de nieuwe taal. Controleer of je apparaat toegang heeft tot internet, start de app opnieuw op en probeer het opnieuw.",
	},
