...
export const ptPT: I18nLocale = {
	...
	languageSelector: {
		...
		language: "Idioma",
		changeLanguageError:
			"Ocorreu um erro ao configurar o novo idioma. Por favor, certifique-se de que o seu dispositivo está ligado à Internet, reinicie a aplicação e tente novamente.",
	},
